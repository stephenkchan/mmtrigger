...
struct std_align{
  ...
  string print(bool detailed=false) const;
...
struct par_par{
  ...
  string print_pars(bool detailed=false,bool comp=false) const;
  string detail()const;
...
class MMT_Parameters{
 public: 
  ...
  //dimensions
  float32fixed<18> w1, w2, w3, h1, h2, h3, H, L, wedge_opening_angle;
